...
def eval_class_model(
    ...
    if is_multiclass:
        ...
        # AUC multiclass
        model_metrics.update({"auc-micro": metrics.roc_auc_score(ytest_b, yprob, multi_class="ovo", average="micro"),
                              "auc-weighted": metrics.roc_auc_score(ytest_b, yprob, multi_class="ovo", average="weighted")})

        # others (todo - macro, micro...)
        model_metrics.update({"f1-score": metrics.f1_score(ytest, ypred, average="micro"),
