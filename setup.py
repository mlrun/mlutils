...
def version():
    with open('mlutils/__init__.py') as fp:
        for line in fp:
...
setup(
    name='mlutils',
    version=version(),
    description='utilities for working with machine learning apis',
    long_description=long_desc,
    long_description_content_type='text/markdown',
    author='Yasha Borstein',
    author_email='yashab@iguazio.com',
    license='Apache-2.0',
    url='https://github.com/mlrun/mlutils',
    packages=['mlutils'],
